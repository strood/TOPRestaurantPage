...
const renderSmall = (menuHolder) => {
  ...
  // Build menu items
  let chefBoard = buildMenuItem("chef's board", "34", "a fine collection of meats, " +
    "cheeses, and other edible delights from the minds of our chefs. Serves 2-4");
  let charcut = buildMenuItem("une petite charcuterie", "18", "a smaller version of the chef’s board. Serves 1-2.");
  let thump = buildMenuItem("thumpers feast", "18", "a vegetarian version of the chef's board. Serves 1-2");
  let poutine = buildMenuItem("cast iron poutine", "12", "potatoes, cheese, bacon in a cast iron fry pan.");
  let tomatoes = buildMenuItem("roasted tomatoes", "12", "roasted tomatoes, with fresh herbs and goat cheese. Served with our own, house-made ciabatta.");
  ...
  let spread = buildMenuItem("spread and bread", "12", "the world's best spinach dip or Maximillion's hummus," +
    " served with Iranian flatbread, seasoned with Zatar spice.");
  let porto = buildMenuItem("eat your rocket, stuffed portabello", "14", "baked portabello, stuffed with cream cheese" +
