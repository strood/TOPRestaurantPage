...
const renderBrunch = (menuHolder) => {
  ...
  let bennyFB = buildMenuItem("traditional benny flatbread", "18", "soft poached eggs, prosciutto, served with lemony house-made hollandaise.");
  let betFB = buildMenuItem("bacon, eggg, and tomato flatbread", "18", "soft poached eggs, bacon and tomato served with lemony house-made hollandaise.");
  let loxFB = buildMenuItem("lox & cream cheese flatbread", "18", "soft poached eggs, bacon and tomato served with lemony house-made hollandaise.");
