...
const renderBig = (menuHolder) => {
  ...
  // Build menu items
  const gojChick = buildMenuItem('gochujang chicken', '22', 'korean-style chicken with coconut rice, topped with nori & sesame seed, served with kim chi slaw.');
  ...
  const mousaka = buildMenuItem('ouzo mousaka', '23', 'sultana raisin beef ragu, roasted eggplant, onion, tomato, bell pepper, garlic, potato, lemon, scented bechamel.');
  const mussels = buildMenuItem('mussels', '24', 'one pound of steamed mussels in spicy white wine sauce, served on a bed of wilted spinach with Tribe made rustic bread.');
